...
let s:black           = { "gui": "#171F27", "cterm": "0"   }
...
let s:dark_blue       = { "gui": "#B6D6FD", "cterm": "153" }
...
let s:light_blue =     { "gui": "#008EC4", "cterm": "4"   }


let s:pink            = { "gui": "#ff97cb", "cterm": "205" }
" let s:orange           = { "gui": "#f2a365", "cterm": "205" }
let s:orange           = { "gui": "#AE6542", "cterm": "205" }
" let s:yellow          = { "gui": "#dfdf87", "cterm": "186"   }
let s:yellow          = { "gui": "#AE9442", "cterm": "186"   }
...
" hi! link TSConstant OrangeItalic
" hi! link TSConstBuiltin OrangeItalic
" hi! link TSConstMacro Orange
...
" hi! link TSLabel Red
" hi! link TSOperator Red
" hi! link TSKeyword Red
" hi! link TSException Red
" hi! link TSType BlueItalic
" hi! link TSTypeBuiltin BlueItalic
" hi! link TSStructure BlueItalic
" hi! link TSInclude BlueItalic
call s:h("TSType",     {"fg": s:medium_gray})
